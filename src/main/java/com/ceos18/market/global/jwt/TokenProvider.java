...
import com.ceos18.market.domain.auth.RefreshTokenRepository;
...
public class TokenProvider implements InitializingBean {
    ...
    public TokenDto createAccessToken(Authentication authentication) {
        ...
        Optional<RefreshToken> oldRefreshToken = refreshTokenRepository.findByUserId(authentication.getName());
    ...
    public boolean refreshTokenValidation(String token) {
        ...
        Optional<RefreshToken> refreshToken = refreshTokenRepository.findByUserId(getEmailFromToken(token));
